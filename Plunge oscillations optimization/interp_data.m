...
switch source
    ...
    case "GU"
        [time_ref_interp,alpha_ref_interp,cn_ref_interp,cm_ref_interp,cc_ref_interp,cl_ref_interp,cd_ref_interp,interp] = interp_coefs_GU(data,a_0,a_1,t,t_cycle,interp,N_interp,interp_method);
    case "OSU"
