function [outputs,tp,xp,yp,xdotp] = BLtvfsc_RKF45(tspan,x0,y0,params,RKF_options)
...
% Set initial outputs
alpha0 = a_0+a_1*sin(psi_a);
alphadot0 = a_1*k*U_0/b*cos(psi_a);
q0 = 2*b*alphadot0/U_0;
M0 = U_0/a_inf; 
w_tqc0 = U_0*atan((U_0*sin(alpha0)+b*alphadot0)/(U_0*cos(alpha0)));
cnaw_tqc0 = c_n_alpha*w_tqc0;
Ucm_qs0 = -1/8*c_n_alpha*b*alphadot0;
[yp(:,i),cnaw_tqc_vec(i),alpha_vec(i),alphadot_vec(i),M_vec(i),Ucm_qs_vec(i),s_vec(i),q_vec(i)] = BLtvfsc_outputs(tc,x_i,tv0,[tc,tc],cnaw_tqc0,alpha0,alphadot0,M0,Ucm_qs0,0,q0,a_inf,b,k,a_0,a_1,U_0,U_1,k_U,psi_a,K0,K1,K1_f,K2,K3,kappa,b1,b2,b3,b4,b5,A1,A2,A3,A4,alpha_0L,E0,E1,c_m0,r0,alpha_ds0,alpha_ss,alpha1_0,S1,S2,Ta,Tf0,f0,fb,Vn1,Vn2,Vm,c_d0,delta_alpha_0,delta_alpha_1,delta_alpha_2,d_cm,d_cc,z_cm,z_cc,nu_1,nu_2,gamma_LS,df0_c,fSig1n,fSig1c,fSig2n,fS2n_ulpr,fS2n_dlpr,fS1n_u,fS1m_u,fS1c_u,fS1n_d,fS1m_d,fS1c_d,fS1n_ud,fS1m_ud,fS1c_ud,fS2n_u,fS2m_u,fS2c_u,fS2n_d,fS2m_d,fS2c_d,fSS1,fSS2,g_v,x_i(5),f_diff_tv0,TvL_tv0,theta_tv0,theta_max,theta_min,RD_m,f_diff_tv0_2,RD_tv0_2,TvL_tv0_2,TvL);
...
while tc < tf
    ...
    xp(:,i+1) = x_ip1;
    xdotp(:,i) = xdot_i;
    [yp(:,i+1),cnaw_tqc_vec(i+1,1),alpha_vec(i+1,1),alphadot_vec(i+1,1),M_vec(i+1,1),Ucm_qs_vec(i+1,1),s_vec(i+1,1),q_vec(i+1,1)] = BLtvfsc_outputs(tc+dt,x_ip1,tv0,tp(1:i+1),cnaw_tqc_vec(1:i),alpha_vec(1:i),alphadot_vec(1:i),M_vec(1:i),Ucm_qs_vec(1:i),s_vec(1:i),q_vec(1:i),a_inf,b,k,a_0,a_1,U_0,U_1,k_U,psi_a,K0,K1,K1_f,K2,K3,kappa,b1,b2,b3,b4,b5,A1,A2,A3,A4,alpha_0L,E0,E1,c_m0,r0,alpha_ds0,alpha_ss,alpha1_0,S1,S2,Ta,Tf0,f0,fb,Vn1,Vn2,Vm,c_d0,delta_alpha_0,delta_alpha_1,delta_alpha_2,d_cm,d_cc,z_cm,z_cc,nu_1,nu_2,gamma_LS,df0_c,fSig1n,fSig1c,fSig2n,fS2n_ulpr,fS2n_dlpr,fS1n_u,fS1m_u,fS1c_u,fS1n_d,fS1m_d,fS1c_d,fS1n_ud,fS1m_ud,fS1c_ud,fS2n_u,fS2m_u,fS2c_u,fS2n_d,fS2m_d,fS2c_d,fSS1,fSS2,g_v_tv0,RD_tv0,f_diff_tv0,TvL_tv0,theta_tv0,theta_max,theta_min,RD_m,f_diff_tv0_2,RD_tv0_2,TvL_tv0_2,TvL);
