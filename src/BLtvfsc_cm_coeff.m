function [c_m,c_mf,c_mI,dCP] = BLtvfsc_cm_coeff(c_nf,U,q,Ucm_qs_eff,int_conv_Iam,int_conv_Iqm,int_conv_IMm,K0,K1,K1_f,K2,K3,kappa,c_m0,f2prime_m,theta,R,S,P,RD,cm_v)
...
% Impulsive
c_mI = int_conv_Iam+int_conv_Iqm+int_conv_IMm;
