function [c_m,c_mf,c_mI,dCP] = BLTtvfs_cm_coeff(c_nf,M,alphadot,alphaddot,q,K0,K1,K1_f,K2,K3,kappa,c_m0,U,b,f2prime_m,theta,R,S,P,RD,cm_v)

% Get center of pressure variables at current Mach
K0 = CPvars_of_M(M);
...
% Impulsive 
c_mI = -pi*b/(2*U^2)*(U*alphadot+3/8*b*alphaddot);
