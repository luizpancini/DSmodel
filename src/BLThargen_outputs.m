...
[wg,vg,w0,F_theta0,F2_theta0,theta0] = gust_kin_inc(wg_fun,t,U,b,lambda_g);
...
% c_n
[c_n,c_nC,c_nf,c_nI,c_nIa,c_nIf,c_nIg,w_E,w_Ep,w_Ef,w_Eg,alpha_E] = BLThargen_cn_coeff(x,c_nv,gust_states,U,Udot,b,ah,Uc,w_tqc_pp,alpha,alphadot,alphaddot,hddot,deltadot,deltaddot,w_tqc_f,w0,wg,vg,AG,bG,Cg,f2prime_n,T1,T4,alpha_0L,c_n_alpha,eps_fn,F_theta0,F_theta0_i,t-t_i);
% c_m
[c_m,c_mC,c_mf,c_mQS,c_mI,c_mIa,c_mIf,c_mIg,dCP] = BLThargen_cm_coeff(airfoil,c_nC,c_nf,c_mv,f2prime_m,theta,R,S,P,RD,upstroke,ah,dh,U,Udot,b,M,alpha,alphadot,alphaddot,hddot,delta,deltadot,deltaddot,Ucm_QS,eps_fm,kappa_0,kappa_1,kappa_2,kappa_3,c_m0,T1,T4,T7,T8,T10,T11,w0,F2_theta0,F2_theta0_i,t-t_i);
% c_c
