function [wg,alpha_g,w0,alpha_g0,F_theta0,F2_theta0,theta0] = get_convecting_alpha_g(wg_fun,t,U,b,lambda_g)
...
if t >= 0
    if lambda_g > 0 % Downstream convecting gust
        ...
        % Current gust-induced normal velocity
