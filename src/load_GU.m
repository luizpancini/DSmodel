function [params,data] = load_GU(GUD)

% Load experimental condition variables
filepath = sprintf('../Glasgow Data/GUD_%08d.mat', GUD);        
load(filepath,'authors','airfoil','b','a_inf','M','U','beta','k','a_0','a_1','ah','time','alpha','cl','cd','cm','cn','cc');
% ah = 1/2
