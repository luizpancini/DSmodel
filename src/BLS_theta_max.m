function theta_max = BLS_theta_max(q_i,so_im1,so_i,so_ip1,so_lim_im1,so_lim_i,so_lim_ip1,theta_max)

% Stall onset ratio at previous, current and next time steps
