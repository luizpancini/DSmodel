function [c_n,c_m,c_c,alpha_re_i,cn_re_i,cm_re_i,cc_re_i,cn_re_f,cm_re_f,cc_re_f,tri,trf] = BLS_reattach(t,b,U,alpha,q,tau_v,TvL,a_0,a_1,c_n_alpha,alpha_min0,Tr,r_dcn_da_reat,r_dcm_da_reat,r_dcc_da_reat,c_n,c_m,c_c,alpha_re_i,cn_re_i,cm_re_i,cc_re_i,cn_re_f,cm_re_f,cc_re_f,tri,trf,theta_max)

% Maximum angle of attack in the cycle
alpha_max = a_0+a_1;
