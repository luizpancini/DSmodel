...
%% Separation points
[f,fprime_n,fprime_m,fprime_c,Sigma2] = BL_sep_points(alpha_lag,f0,fb,alpha,alpha1_n,alpha1_0,S1,S2,R,q,theta,RD,alpha1_m,alpha1_c,theta_max,theta_min,RD_tv0,Rdot,P,T,df0_c,fSig1n,fSig1c,fSig2n,fS2n_ulpr,fS2n_dlpr,fS1n_u,fS1m_u,fS1c_u,fS1n_d,fS1m_d,fS1c_d,fS1n_ud,fS1m_ud,fS1c_ud,fS2n_u,fS2m_u,fS2c_u,fS2n_d,fS2m_d,fS2c_d);
...
[c_n_alpha,K0] = airspeed_vars(M,beta,c_n_alpha0);
% Convolution integrals
[X,cnaw_tqc,cnaw_tqc_eff,Ucm_qs_eff] = BLtvfsr_recurrence_states(y_p,t,t_i,a_inf,b,U,M,beta,alpha,w_tqc,q,Ucm_qs,c_n_alpha,A1,A2,A3,A4,b1,b2,b3,b4,b5);
% Vortex overshoots  
...
% c_n
[c_n,c_nC,c_nf,c_nI,alpha_E,K_f] = BLtvfsr_cn_coeff(X,U,cnaw_tqc_eff,c_n_alpha,f2prime_n,alpha_0L,cn_v);
% c_m
[c_m,c_mf,c_mI,dCP] = BLtvfsr_cm_coeff(X,c_nf,U,q,Ucm_qs_eff,K0,K1,K1_f,K2,K3,kappa,c_m0,f2prime_m,theta,R,S,P,RD,cm_v);
% c_c
c_c = BL_cc_coeff(alpha,f2prime_c,theta,c_n_alpha,alpha_E,E0,E1,c_d0,alpha_0L,RD,cc_v);
 
%% Outputs
y = [alpha; c_n; c_m; c_c; c_nf; c_nI; c_mf; c_mI; cn_v; cm_v; cc_v; f; tau_v; dCP; so_lim; qR; alpha1_n; K_f; c_nC; Tf_n; dalpha1_n; fprime_n; fprime_m; fprime_c; q; dalpha1_m; dalpha1_c; Rdot; Tf_m; Tf_c; theta_min; theta_max; P; S; alpha_E; U; beta; cnaw_tqc; Ucm_qs; X];
