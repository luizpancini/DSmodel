...
%% States
alpha_lag = atan((x(1)+x(7))/(Uc+vg)); % Composition of pitch-plunge and gust induced AoA
RD = x(5);
RD_theta = x(6);
...
%% State-space
xdot = BLThargen_state_space(x,xdot,b,U,beta,w_QS,cnawdot_tqc,wdot_tqc_f,R,wg,Tf_n,Tf_m,Tf_c,Ta,fprime_n,fprime_m,fprime_c,Ta_theta,A1,A2,b1,b2,A1W,A2W,b1W,b2W,bG);
