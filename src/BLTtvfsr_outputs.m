...
[X,w_tqc_eff] = BLTtvfsr_recurrence_states(y,t,t_i,b,U,alpha,alphadot,w_tqc,A1,A2,b1,b2);
% Vortex overshoots
...
% c_n
[c_n,c_nC,c_nf,c_nI,alpha_E,K_f] = BLTtvfs_cn_coeff(U,b,w_tqc_eff,w_tqc_dot,c_n_alpha,f2prime_n,alpha_0L,cn_v);
% c_m
[c_m,c_mf,c_mI,dCP] = BLTtvfs_cm_coeff(c_nf,M,alphadot,alphaddot,q,K0,K1,K1_f,K2,K3,kappa,c_m0,U,b,f2prime_m,theta,R,S,P,RD,cm_v);
% c_c
c_c = BL_cc_coeff(alpha,f2prime_c,theta,c_n_alpha,alpha_E,E0,E1,c_d0,alpha_0L,RD,cc_v);
 
%% Outputs
y = [alpha; c_n; c_m; c_c; c_nf; c_nI; c_mf; c_mI; cn_v; cm_v; cc_v; f; tau_v; dCP; so_lim; qR; alpha1_n; K_f; c_nC; Tf_n; dalpha1_n; fprime_n; fprime_m; fprime_c; q; dalpha1_m; dalpha1_c; Rdot; Tf_m; Tf_c; theta_min; theta_max; P; S; alpha_E; U; alphadot; X];
