...
% c_n
[c_n,c_nC,c_nf,c_nI,alpha_E,K_f] = BLTtvfs_cn_coeff(x,b,U,Udot,alpha,alphadot,alphaddot,w_tqc,c_n_alpha,f2prime_n,alpha_0L,cn_v);
% c_m
...
%% Outputs
y = [alpha; c_n; c_m; c_c; c_nf; c_nI; c_mf; c_mI; cn_v; cm_v; cc_v; f; tau_v; dCP; so_lim; qR; alpha1_n; K_f; c_nC; Tf_n; dalpha1_n; fprime_n; fprime_m; fprime_c; q; dalpha1_m; dalpha1_c; Rdot; Tf_m; Tf_c; theta_min; theta_max; P; S; alpha_E; U; w_tqc; M; beta];
