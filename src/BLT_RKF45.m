function [outputs,tp,xp,yp,xdotp] = BLT_RKF45(tspan,x0,y0,params,RKF_options)
...
[U,b,ah,beta,a_0,a_1,k,a_1h,k_h,A,c1,c2,c3,c4,A1,A2,b1,b2,alpha_0L,alpha_ds0,alpha_ss,alpha1_0,gamma_LS,gamma_TvLs,gamma_TvLc,delta_alpha_0,delta_alpha_1,delta_alpha_2,kappa,nu_1,nu_2,nu_3,c_d0,c_m0,c_n_alpha,d_cc,d_cm,df0_c,E0,E1,f0,fb,fSig1n,fSig1c,fSig2n,fS2n_ulpr,fS2n_dlpr,fS1n_u,fS1m_u,fS1c_u,fS1n_d,fS1m_d,fS1c_d,fS1n_ud,fS1m_ud,fS1c_ud,fS2n_u,fS2m_u,fS2c_u,fS2n_d,fS2m_d,fS2c_d,fSS1,fSS2,g_v,K0,K1,K1_f,K2_f,K2,K3,r0,S1,S2,Ta,Tf0,TvL,Vm,Vn1,Vn2,x_ac,z_cc,z_cm] = BLT_unpack_params(params);
% Initialize model's complementary variables
tv0 = 0; t_ub = 0; t_db = 0; alpha_lag_i = 0; alpha_cr_i = 1; theta_i = 0; R_i = 0; RD_tv0 = 0; f_diff_tv0 = 0; TvL_tv0 = -1e4; theta_tv0 = 0; RD_tv0_2 = 1; f_diff_tv0_2 = 0; TvL_tv0_2 = -1e4;  V2F = 0; theta_min_i = 0; theta_max_i = 1; RD_m_i = 1; R_max_i = 1;
...
outputs = BLT_output_vars(tp,xp,yp,xdotp);
