function [outputs,tp,xp,yp,xdotp] = BLTtvfsr_RKF45(tspan,x0,y0,params,RKF_options)
...
% Set initial outputs
yp(end-3,1) = U_0;                      % U
yp(1,1) = a_0+a_1*sin(psi_a);           % alpha
yp(end-2,1) = a_1*k*U_0/b*cos(psi_a);   % alphadot
yp(end-1:end,1) = 0;                    % Deficiency functions (states)
