function [outputs,tp,xp,yp,xdotp] = BLtvfs_RKF45(tspan,x0,y0,params,RKF_options)
...
while tc < tf
    ...
    while (eps > RKFtol || any(boundary < delta_b)) 
        ...
        dt = min([dt,tf-tc]); 
        % RKF45 steps
        [k1,tv0,t_db,so_i,so_lim_i,alpha1n_i,alpha1m_i,alpha1c_i,alpha_bar_i,q_bar_i,fprime_n_i,fprime_m_i,fprime_c_i,dalpha1_n_i,beta_db_n_i,beta_db_m_i,beta_db_c_i,dalpha1_db_i,RD_db_i,R_i] = BLtvfs_dxdt(tc,x_i,xdot_i,tc,tv0,t_db,RD_tv0,f_diff_tv0,TvL_tv0,theta_tv0,f_diff_tv0_2,RD_tv0_2,TvL_tv0_2,V2F,so_i,so_lim_i,upstroke_i,fprime_n_i,fprime_m_i,fprime_c_i,dalpha1_n_i,beta_db_n_i,beta_db_m_i,beta_db_c_i,dalpha1_db_i,RD_db_i,a_inf,b,a_0,a_1,k,U_0,U_1,k_U,psi_a,A1,A2,A3,A4,b1,b2,b3,b4,b5,S1,S2,TvL,Ta,Tf0,r0,alpha_ds0,alpha_ss,alpha1_0,f0,fb,delta_alpha_0,delta_alpha_1,delta_alpha_2,d_cm,d_cc,z_cm,z_cc,gamma_LS,g_v,df0_c,fSS1,fSS2,fSig1n,fSig1c,fSig2n,fS2n_ulpr,fS2n_dlpr,fS1n_u,fS1m_u,fS1c_u,fS1n_d,fS1m_d,fS1c_d,fS1n_ud,fS1m_ud,fS1c_ud,fS2n_u,fS2m_u,fS2c_u,fS2n_d,fS2m_d,fS2c_d,gamma_TvL,theta_max,theta_min,RD_m,R_max); 
        x1 = x_i + k1*dt/4;
        [k2,tv0,t_db] = BLtvfs_dxdt(tc+dt/4,x1,xdot_i,tc,tv0,t_db,RD_tv0,f_diff_tv0,TvL_tv0,theta_tv0,f_diff_tv0_2,RD_tv0_2,TvL_tv0_2,V2F,so_i,so_lim_i,upstroke_i,fprime_n_i,fprime_m_i,fprime_c_i,dalpha1_n_i,beta_db_n_i,beta_db_m_i,beta_db_c_i,dalpha1_db_i,RD_db_i,a_inf,b,a_0,a_1,k,U_0,U_1,k_U,psi_a,A1,A2,A3,A4,b1,b2,b3,b4,b5,S1,S2,TvL,Ta,Tf0,r0,alpha_ds0,alpha_ss,alpha1_0,f0,fb,delta_alpha_0,delta_alpha_1,delta_alpha_2,d_cm,d_cc,z_cm,z_cc,gamma_LS,g_v,df0_c,fSS1,fSS2,fSig1n,fSig1c,fSig2n,fS2n_ulpr,fS2n_dlpr,fS1n_u,fS1m_u,fS1c_u,fS1n_d,fS1m_d,fS1c_d,fS1n_ud,fS1m_ud,fS1c_ud,fS2n_u,fS2m_u,fS2c_u,fS2n_d,fS2m_d,fS2c_d,gamma_TvL,theta_max,theta_min,RD_m,R_max);
        x2 = x_i + (3/32*k1+9/32*k2)*dt;
        [k3,tv0,t_db] = BLtvfs_dxdt(tc+3/8*dt,x2,xdot_i,tc,tv0,t_db,RD_tv0,f_diff_tv0,TvL_tv0,theta_tv0,f_diff_tv0_2,RD_tv0_2,TvL_tv0_2,V2F,so_i,so_lim_i,upstroke_i,fprime_n_i,fprime_m_i,fprime_c_i,dalpha1_n_i,beta_db_n_i,beta_db_m_i,beta_db_c_i,dalpha1_db_i,RD_db_i,a_inf,b,a_0,a_1,k,U_0,U_1,k_U,psi_a,A1,A2,A3,A4,b1,b2,b3,b4,b5,S1,S2,TvL,Ta,Tf0,r0,alpha_ds0,alpha_ss,alpha1_0,f0,fb,delta_alpha_0,delta_alpha_1,delta_alpha_2,d_cm,d_cc,z_cm,z_cc,gamma_LS,g_v,df0_c,fSS1,fSS2,fSig1n,fSig1c,fSig2n,fS2n_ulpr,fS2n_dlpr,fS1n_u,fS1m_u,fS1c_u,fS1n_d,fS1m_d,fS1c_d,fS1n_ud,fS1m_ud,fS1c_ud,fS2n_u,fS2m_u,fS2c_u,fS2n_d,fS2m_d,fS2c_d,gamma_TvL,theta_max,theta_min,RD_m,R_max);
        x3 = x_i + (1932*k1-7200*k2+7296*k3)/2197*dt;
        [k4,tv0,t_db] = BLtvfs_dxdt(tc+12/13*dt,x3,xdot_i,tc,tv0,t_db,RD_tv0,f_diff_tv0,TvL_tv0,theta_tv0,f_diff_tv0_2,RD_tv0_2,TvL_tv0_2,V2F,so_i,so_lim_i,upstroke_i,fprime_n_i,fprime_m_i,fprime_c_i,dalpha1_n_i,beta_db_n_i,beta_db_m_i,beta_db_c_i,dalpha1_db_i,RD_db_i,a_inf,b,a_0,a_1,k,U_0,U_1,k_U,psi_a,A1,A2,A3,A4,b1,b2,b3,b4,b5,S1,S2,TvL,Ta,Tf0,r0,alpha_ds0,alpha_ss,alpha1_0,f0,fb,delta_alpha_0,delta_alpha_1,delta_alpha_2,d_cm,d_cc,z_cm,z_cc,gamma_LS,g_v,df0_c,fSS1,fSS2,fSig1n,fSig1c,fSig2n,fS2n_ulpr,fS2n_dlpr,fS1n_u,fS1m_u,fS1c_u,fS1n_d,fS1m_d,fS1c_d,fS1n_ud,fS1m_ud,fS1c_ud,fS2n_u,fS2m_u,fS2c_u,fS2n_d,fS2m_d,fS2c_d,gamma_TvL,theta_max,theta_min,RD_m,R_max);
        x4 = x_i + (439/216*k1-8*k2+3680/513*k3-845/4104*k4)*dt;
        [k5,tv0,t_db,so_ip1,so_lim_ip1,alpha1n_ip1,alpha1m_ip1,alpha1c_ip1,alpha_bar_ip1,q_bar_ip1,fprime_n_ip1,fprime_m_ip1,fprime_c_ip1,dalpha1_n_ip1,beta_db_n_ip1,beta_db_m_ip1,beta_db_c_ip1,dalpha1_db_ip1,RD_db_ip1,R_ip1,g_v_tv0,RD_tv0,f_diff_tv0,TvL_tv0,theta_tv0,f_diff_tv0_2,RD_tv0_2,TvL_tv0_2,V2F] = BLtvfs_dxdt(tc+dt,x4,xdot_i,tc,tv0,t_db,RD_tv0,f_diff_tv0,TvL_tv0,theta_tv0,f_diff_tv0_2,RD_tv0_2,TvL_tv0_2,V2F,so_i,so_lim_i,upstroke_i,fprime_n_i,fprime_m_i,fprime_c_i,dalpha1_n_i,beta_db_n_i,beta_db_m_i,beta_db_c_i,dalpha1_db_i,RD_db_i,a_inf,b,a_0,a_1,k,U_0,U_1,k_U,psi_a,A1,A2,A3,A4,b1,b2,b3,b4,b5,S1,S2,TvL,Ta,Tf0,r0,alpha_ds0,alpha_ss,alpha1_0,f0,fb,delta_alpha_0,delta_alpha_1,delta_alpha_2,d_cm,d_cc,z_cm,z_cc,gamma_LS,g_v,df0_c,fSS1,fSS2,fSig1n,fSig1c,fSig2n,fS2n_ulpr,fS2n_dlpr,fS1n_u,fS1m_u,fS1c_u,fS1n_d,fS1m_d,fS1c_d,fS1n_ud,fS1m_ud,fS1c_ud,fS2n_u,fS2m_u,fS2c_u,fS2n_d,fS2m_d,fS2c_d,gamma_TvL,theta_max,theta_min,RD_m,R_max);
        x5 = x_i + (-8/27*k1+2*k2-3544/2565*k3+1859/4104*k4-11/40*k5)*dt;
        [k6,tv0,t_db] = BLtvfs_dxdt(tc+dt/2,x5,xdot_i,tc,tv0,t_db,RD_tv0,f_diff_tv0,TvL_tv0,theta_tv0,f_diff_tv0_2,RD_tv0_2,TvL_tv0_2,V2F,so_i,so_lim_i,upstroke_i,fprime_n_i,fprime_m_i,fprime_c_i,dalpha1_n_i,beta_db_n_i,beta_db_m_i,beta_db_c_i,dalpha1_db_i,RD_db_i,a_inf,b,a_0,a_1,k,U_0,U_1,k_U,psi_a,A1,A2,A3,A4,b1,b2,b3,b4,b5,S1,S2,TvL,Ta,Tf0,r0,alpha_ds0,alpha_ss,alpha1_0,f0,fb,delta_alpha_0,delta_alpha_1,delta_alpha_2,d_cm,d_cc,z_cm,z_cc,gamma_LS,g_v,df0_c,fSS1,fSS2,fSig1n,fSig1c,fSig2n,fS2n_ulpr,fS2n_dlpr,fS1n_u,fS1m_u,fS1c_u,fS1n_d,fS1m_d,fS1c_d,fS1n_ud,fS1m_ud,fS1c_ud,fS2n_u,fS2m_u,fS2c_u,fS2n_d,fS2m_d,fS2c_d,gamma_TvL,theta_max,theta_min,RD_m,R_max);
        k_step = [k1, k2, k3, k4, k5, k6];
        % Update minima and maxima of stall onset ratio
        [theta_min,theta_max,RD_m,R_max] = BL_so_ratio_extremes(q_bar_ip1,so_i,so_ip1,so_lim_i,so_lim_ip1,x_i(5),theta_min,theta_max,RD_m,R_max,R_i,R_ip1);
    ...
    xp(:,i+1) = x_ip1;
    xdotp(:,i) = xdot_i;
    yp(:,i+1) = BLtvfs_outputs(tc+dt,x_ip1,tv0,t_db,upstroke_i,fprime_n_ip1,fprime_m_ip1,fprime_c_ip1,dalpha1_n_ip1,beta_db_n_ip1,beta_db_m_ip1,beta_db_c_ip1,dalpha1_db_ip1,RD_db_ip1,a_inf,b,k,a_0,a_1,U_0,U_1,k_U,psi_a,K0,K1,K1_f,K2,K3,kappa,alpha_0L,E0,E1,c_m0,r0,alpha_ds0,alpha_ss,alpha1_0,S1,S2,Ta,Tf0,f0,fb,Vn1,Vn2,Vm,c_d0,delta_alpha_0,delta_alpha_1,delta_alpha_2,d_cm,d_cc,z_cm,z_cc,nu_1,nu_2,gamma_LS,df0_c,fSig1n,fSig1c,fSig2n,fS2n_ulpr,fS2n_dlpr,fS1n_u,fS1m_u,fS1c_u,fS1n_d,fS1m_d,fS1c_d,fS1n_ud,fS1m_ud,fS1c_ud,fS2n_u,fS2m_u,fS2c_u,fS2n_d,fS2m_d,fS2c_d,fSS1,fSS2,g_v_tv0,RD_tv0,f_diff_tv0,TvL_tv0,theta_tv0,theta_max,theta_min,RD_m,R_max,f_diff_tv0_2,RD_tv0_2,TvL_tv0_2,TvL);
    % Setup next time step
    tc = tc+dt;
    x_i = x_ip1;
    so_i = so_ip1;
    so_lim_i = so_lim_ip1;
    upstroke_i = so_i/so_lim_i*q_bar_ip1 > 0;
    fprime_n_i = fprime_n_ip1;
    fprime_m_i = fprime_m_ip1;
    fprime_c_i = fprime_c_ip1;
    dalpha1_n_i = dalpha1_n_ip1;
    beta_db_n_i = beta_db_n_ip1;
    beta_db_m_i = beta_db_m_ip1;
    beta_db_c_i = beta_db_c_ip1;
